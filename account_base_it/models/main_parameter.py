...
class MainParameter(models.Model):
	...
	balance_sheet_account = fields.Many2one('account.account',string='Cuenta Cierre Contable')
	lost_result_account = fields.Many2one('account.account',string='Cuenta Resultados A.C. Perdida')
	profit_result_account = fields.Many2one('account.account',string='Cuenta Resultados A.C. Ganacia')

	####KARDEX####

	#analytic_tag = fields.Many2one('account.analytic.tag',string='Etiqueta Analitica')
