...
class AccountHigherRep(models.TransientModel):
	...
	def get_excel(self,filtro):
		...
		HEADERS = ['PERIODO','FECHA','LIBRO','VOUCHER','CUENTA','DEBE','HABER','BALANCE','SALDO MN','MON','TC','IMPORTE ME',
				   'SALDO ME','CTA ANALITICA','GLOSA','TDP','RUC','PARTNER','TD','NRO COMPROBANTE','FECHA DOC','FECHA VEN']
		x=1
