...
class AccountAccount(models.Model):
	...
	m_close = fields.Selection([
								('1','Costo de Ventas'),
								('2','Cancelacion Clase 9'),
								('3','Margen Comercial'),
								('4','Produccion del Ejercicio'),
								('5','Valor Agregado'),
								('6','Excedente o Insuficiencia'),
								('7','Resultado de Explotacion'),
								('8','Resultado antes de Participaciones'),
								('9','Cierre de Activo y Pasivo')
