...
class ResPartner(models.Model):
	...
	p_detraction = fields.Integer(string='Porcentaje Detraccion')
	...
	def _customer_rank_one(self):
		for i in self:
			if i.is_supplier:
				self._increase_rank_it('customer_rank')
			else:
				self._decrease_rank_it('customer_rank')

	@api.onchange('is_supplier')
	def _supplier_rank_one(self):
		for i in self:
			if i.is_supplier:
				self._increase_rank_it('supplier_rank')
			else:
				self._decrease_rank_it('supplier_rank')
